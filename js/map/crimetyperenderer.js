define(['dojo', 'esri/renderers/UniqueValueRenderer', 'esri/symbols/SimpleMarkerSymbol'], function (dojo, UniqueValueRenderer, SimpleMarkerSymbol) {
	...
	renderer.addValue({
		value: 'Store Robbery',
		symbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 14, null, new dojo.Color([35, 149, 232, 0.7])),
		label: 'Store Robbery',
		description: ''
	});
	...
	renderer.addValue({
		value: 'Home Burglary',
		symbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 14, null, new dojo.Color([35, 232, 49, 0.7])),
		label: 'Home Burglary',
		description: ''
	});
	...
	renderer.addValue({
		value: 'Car Break-in',
		symbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 14, null, new dojo.Color([232, 126, 35, 0.7])),
		label: 'Car Break-in',
		description: ''
	});
	...
	renderer.addValue({
		value: 'Suspect Chase',
		symbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 14, null, new dojo.Color([232, 35, 215, 0.7])),
		label: 'Suspect Chase',
		description: ''
	});
